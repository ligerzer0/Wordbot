...
#-------------------------------------------------------------------------------------------------------------------------------
#This matches a string "wordbot analyze [?]" where ? will be tried as Redditor's username 
TRIGGER_PATTERN = re.compile('\w*wordbot\sanalyze\s\[([^]]*)\]')
#Words to omit from the analysis
ignore_words = ['that' , 'the' , 'to', 'and' , 'a' , 'it' , 'in', 'is', 'this' , 'on', 'not', 'are', 'or' , 'but', 'for' , 'of', 'was', 'as', 'with', 'if' , 'so' , 'can', 'what' , 'from', '**', 'its' , 'they' , 'your' , 'their' , 'them' , 'when', 'theyre' , 'there' , 'dont' ]
...
#-------------------------------------------------------------------------------------------------------------------------------
#       And these, it's perfectly okay to leave as they are. But of course, don't let me tell you what you can't do
#-------------------------------------------------------------------------------------------------------------------------------
#User Agent description; this is required in the arguments when creating a User Agent
USER_AGENT = ("User-Agent: {0} {1} by /u/{2}".format(BOT_AGENT_NAME, VERSION, CREATOR ))
...
SLEEP_TIME = 7*60
#How often while sleeping should the bot wake up and send a quick message before going back to sleep
SLEEP_INTERVAL = 20
